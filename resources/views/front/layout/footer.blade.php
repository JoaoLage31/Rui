...
<div id="sec_4" class="section_4">
    <div class="contact_me_on col-xl-6 d-flex justify-content-end">
        <div class="col-xl-11">
            <div data-aos="fade-right"  data-aos-duration="2000" class="section_4__title_posisiton"> <h2 class="section_4__title_buttons"> YOU would like to contact me? </h2></div>
